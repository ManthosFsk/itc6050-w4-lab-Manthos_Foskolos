...
ALTER TABLE fct_orders
    ...
    ADD CONSTRAINT fk_fct_product
        FOREIGN KEY (product_key)
        REFERENCES dim_product(product_key),

    ADD CONSTRAINT fk_fct_date
        FOREIGN KEY (date_key)
        REFERENCES dim_date(date_key);

-- Indexes
CREATE INDEX idx_fct_customer
ON fct_orders(customer_key);

CREATE INDEX idx_fct_product
ON fct_orders(product_key);

CREATE INDEX idx_fct_date
ON fct_orders(date_key);

CREATE INDEX idx_fct_status
